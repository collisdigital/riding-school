...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_rider_profiles_school_id'), 'rider_profiles', ['school_id'], unique=False)
    op.create_index(op.f('ix_rider_profiles_user_id'), 'rider_profiles', ['user_id'], unique=False)
